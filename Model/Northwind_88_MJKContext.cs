...
{
    public partial class Northwind_88_MJKContext : DbContext
    {
        public Northwind_88_MJKContext()
        {
        }

        public Northwind_88_MJKContext(DbContextOptions<Northwind_88_MJKContext> options)
            : base(options)
        {
        }
